...
<head>
    ...
    <title>Penerimaan Siswa Baru - SMAN 3 Sijunjung</title>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: url('assets/img/sma.jpg') no-repeat center center fixed; /* Tambahkan gambar latar belakang */
            background-size: cover; /* Menyesuaikan ukuran gambar */
        }
        .header {
            background-color: rgba(0, 188, 212, 0.8); /* Warna latar belakang header dengan transparansi */
...
<body>
    <div class="header">
        <img src="assets/img/logosma.png" alt="Logo SMAN 3 Sijunjung">
        <div>
            <h1>Penerimaan Peserta Didik Baru</h1>
            <p>SMAN 3 SIJUNJUNG <br>Tahun Pelajaran 2024/2025</p>
        </div>
    </div>
